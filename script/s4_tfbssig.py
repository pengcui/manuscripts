# This script is to compute the tfbs signal in all dnase1 peaks.
import os
import re
...
modnamelist=[]
# get the mod namesfor eachitem in os.listdir('/home/ckivip/Epigenetics/Data/H1hesc/TFBS/signal2'):
for eachitem in os.listdir('/home/ckivip/Epigenetics/Data/H1hesc/TFBS/signal10'):
	modname=eachitem[22:-6]
...
# do it!
resultfile=open('/home/ckivip/mywork/Dnase1/zlater/data/featuresig/tfbsresult10','w')
...
for j in range(0,23):
	...
	moddict=readmodify('/home/ckivip/Epigenetics/Data/H1hesc/TFBS/signal10',uniquechr)
